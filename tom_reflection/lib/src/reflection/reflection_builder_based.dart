...
library tom_reflection.src.reflection_builder_based;

import 'dart:collection' show UnmodifiableMapView;

import '../../tom_reflection.dart';
...
Set<Reflection> get reflectors => data.keys.toSet();
...
// `package:reflection/mirrors.dart`, and they replicate the internal
// implements `structure in package:reflection/mirrors.dart` using `extends`
...
const String pleaseInitializeMessage =
    'Reflection has not been initialized.\n'
    'Please make sure that the first action taken by your program\n'
    'in `main` is to call `initializeReflection()`.';
...
abstract class _DataCaching {
  ...
  // reflection, perform some experiments to detect how useful it is to have
  // this kind of caching.

  ReflectorData? _dataCache;
  ReflectionImpl get _reflector;
...
class _InstanceMirrorImpl extends _DataCaching implements InstanceMirror {
  @override
  final ReflectionImpl _reflector;
  ...
  dynamic delegate(Invocation invocation) {
    Never fail() {
      ...
      // known).
      throw reflectionNoSuchInvokableError(
        reflectee,
  ...
  Object? invokeGetter(String getterName) {
    ...
    // at all. In both cases we consider the invocation to be a capability
    // violation.
    throw reflectionNoSuchGetterError(reflectee, getterName, [], {});
  }
  ...
  Object? invokeSetter(String name, Object? value) {
    ...
    // at all. In both cases we consider the invocation to be a capability
    // violation.
    throw reflectionNoSuchSetterError(reflectee, setterName, [value], {});
  }
}

typedef MethodMirrorProvider = MethodMirror? Function(String methodName);

abstract class ClassMirrorBase<T extends Object> extends _DataCaching implements ClassMirror<T> {
  ...
  Set<T> createSet() => <T>{};
  @override
  Map<K, T> createValuedMap<K>() => <K, T>{};
  @override
  Map<T, V> createKeyedMap<V>() => <T, V>{};
  @override
  Map<T, T> createKeyedValuedMap() => <T, T>{};
  @override
  ...
  @override
  Type get reflectedGenericType {
    return T;
  }
  @override
  List<T?> createNullableList() => <T?>[];
  @override
  Set<T?> createNullableSet() => <T?>{};
  @override
  Map<K, T?> createNullableValuedMap<K>() => <K, T?>{};
  ...
  Object newInstance(
    ...
    Never fail() {
      ...
      throw reflectionNoSuchConstructorError(
        type,
        constructorName,
        positionalArguments,
        namedArguments,
  ...
  Object? invokeGetter(String getterName) {
    ...
    if (getter == null) {
      throw reflectionNoSuchGetterError(reflectedType, getterName, [], {});
    }
    return getter();
  }
...
class NonGenericClassMirrorImpl<T extends Object> extends ClassMirrorBase<T> {
...
class GenericClassMirrorImpl<T extends Object> extends ClassMirrorBase<T> {
...
class InstantiatedGenericClassMirrorImpl<T extends Object> extends ClassMirrorBase<T> {
  ...
  List<Type> get reflectedTypeArguments {
    ...
    return reflectedTypeArgumentIndices
...
InstantiatedGenericClassMirrorImpl<T> _createInstantiatedGenericClass<T extends Object>(
...
class TypeVariableMirrorImpl<T extends Object> extends _DataCaching
    implements TypeVariableMirror<T> {
...
class LibraryMirrorImpl extends _DataCaching implements LibraryMirror {
  ...
  Object? invokeSetter(String name, Object? value) {
    ...
    if (setter == null) {
      throw reflectionNoSuchSetterError(null, setterName, [value], {});
    }
    return setter(value);
  }
...
class MethodMirrorImpl extends _DataCaching implements MethodMirror {
  ...
  /// The [Reflection] associated with this mirror.
  @override
  final ReflectionImpl _reflector;
  ...
  TypeMirror get type {
    ...
    if (_isClassType) {
      ...
      if (typeMirror.isNullable != _isNullable ||
        ...
        if (_isGenericType) {
          return (typeMirror as GenericClassMirrorImpl).createInstantiatedGenericClassMirror(
            hasReflectedType ? reflectedType : null,
        ...
        return _isGenericType
            ? (typeMirror as GenericClassMirrorImpl).createInstantiatedGenericClassMirror(
                hasReflectedType ? reflectedType : null,
                _reflectedTypeArguments,
                _descriptor,
              )
...
class DynamicMirrorImpl<T> extends SpecialTypeMirrorImpl<T> {
...
class VoidMirrorImpl extends SpecialTypeMirrorImpl<void> {
  ...
  @override
  List<void> createList() => <void>[];
  @override
  Set<void> createSet() => <void>{};
  @override
  Map<K, void> createValuedMap<K>() => <K, void>{};
  @override
  Map<void, V> createKeyedMap<V>() => <void, V>{};
  @override
  Map<void, void> createKeyedValuedMap() => <void, void>{};
    @override
  bool isInstanceOf(Object? object) {
    return false;
  }
  ...
  @override
  Type get reflectedGenericType {
    return VoidMirrorImpl;
  }
  @override
  List<void> createNullableList() {
    throw UnimplementedError();
  }

  @override
  Set<void> createNullableSet() {
    throw UnimplementedError();
  }

  @override
  Map<K, void> createNullableValuedMap<K>() {
    throw UnimplementedError();
  }
...
class NeverMirrorImpl extends SpecialTypeMirrorImpl<Never> {
  ...
  @override
  List<Never> createList() => <Never>[];
  @override
  Set<Never> createSet() => <Never>{};
  @override
  Map<K, Never> createValuedMap<K>() => <K, Never>{};
  @override
  Map<Never, V> createKeyedMap<V>() => <Never, V>{};
  @override
  Map<Never, Never> createKeyedValuedMap() => <Never, Never>{};
  @override
  bool isInstanceOf(Object? object) {
    return false;
  }
  ...
  @override
  Type get reflectedGenericType {
    return NeverMirrorImpl;
  }
    @override
  List<Never?> createNullableList() {
    throw UnimplementedError();
  }
  
  @override
  Set<Never?> createNullableSet() {
    throw UnimplementedError();
  }
  
  @override
  Map<K, Never?> createNullableValuedMap<K>() {
    throw UnimplementedError();
  }
...
abstract class ReflectionImpl extends ReflectionBase
  ...
  const ReflectionImpl.fromList(List<ReflectCapability> super.capabilities)
    : super.fromList();
...
bool _supportsType(ReflectionImpl reflector) {
  return reflector.capabilities.any(
    (ReflectCapability capability) => capability is TypeCapability,
  );
}

bool _supportsTypeRelations(ReflectionImpl reflector) {
  return reflector.capabilities.any(
    (ReflectCapability capability) => capability is TypeRelationsCapability,
  );
}

bool _supportsReflectedType(ReflectionImpl reflector) {
  return reflector.capabilities.any(
    (ReflectCapability capability) => capability == reflectedTypeCapability,
  );
}

bool _supportsDeclarations(ReflectionImpl reflector) {
  return reflector.capabilities.any(
