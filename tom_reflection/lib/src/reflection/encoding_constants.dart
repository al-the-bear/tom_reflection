...
library tom_reflection.src.encoding_constants;
...
const voidAttribute = 1 << (flagsBit + 10);
const dynamicAttribute = 1 << (flagsBit + 11);
const neverAttribute = 1 << (flagsBit + 12);
const classTypeAttribute = 1 << (flagsBit + 13);
const voidReturnTypeAttribute = 1 << (flagsBit + 14);
const dynamicReturnTypeAttribute = 1 << (flagsBit + 15);
const neverReturnTypeAttribute = 1 << (flagsBit + 16);
const classReturnTypeAttribute = 1 << (flagsBit + 17);
const enumAttribute = 1 << (flagsBit + 18);
const topLevelAttribute = 1 << (flagsBit + 19);
const genericTypeAttribute = 1 << (flagsBit + 20);
const genericReturnTypeAttribute = 1 << (flagsBit + 21);
const nullableAttribute = 1 << (flagsBit + 22);
const nonNullableAttribute = 1 << (flagsBit + 23);
