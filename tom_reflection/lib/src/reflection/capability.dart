...
// `package:reflection_builder/src/element_capability.dart`,
// and vice versa.
...
/// document](https://github.com/dart-lang/reflection/blob/master/reflection/doc/TheDesignOfReflectionCapabilities.md)
/// about this library.
library tom_reflection.capability;

import '../../tom_reflection.dart';

/// A [ReflectCapability] of a reflection mirror specifies the kinds of
...
/// const constructor superinitializer in a subclass `R` of [Reflection], and
...
/// 'package:reflection/reflection.dart'.
class ImportAttachedCapability {
  final Reflection reflector;
...
class GlobalQuantifyCapability extends ImportAttachedCapability {
  ...
  const GlobalQuantifyCapability(this.classNamePattern, Reflection reflector)
    : super(reflector);
}
...
class GlobalQuantifyMetaCapability extends ImportAttachedCapability {
  final Type metadataType;
  const GlobalQuantifyMetaCapability(this.metadataType, Reflection reflector)
    : super(reflector);
}
...
/// Thrown when a method is invoked via a reflection, but the reflection
/// doesn't have the capabilities to invoke it.
class ReflectionNoSuchMethodError extends Error
    implements NoSuchCapabilityError {
...
dynamic reflectionNoSuchMethodError(
  Object? receiver,
  String memberName,
  List positionalArguments,
  Map<Symbol, dynamic>? namedArguments,
...
dynamic reflectionNoSuchGetterError(
  Object? receiver,
  String memberName,
  List positionalArguments,
  Map<Symbol, dynamic>? namedArguments,
...
dynamic reflectionNoSuchSetterError(
  Object? receiver,
  String memberName,
  List positionalArguments,
  Map<Symbol, dynamic>? namedArguments,
...
dynamic reflectionNoSuchConstructorError(
  Object? receiver,
