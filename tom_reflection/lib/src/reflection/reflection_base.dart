...
library tom_reflection.src.reflection_base;

import 'capability.dart';

/// This class enables sharing of the basic machinery associated with the
/// "varargs" style construction supported by [Reflection] in both
/// `reflection.dart` and `static_reflection.dart`, i.e., the ability to
...
class ReflectionBase {
  ...
  /// of classes having an instance of this ReflectionBase as metadata.
  ...
  const ReflectionBase.fromList(this._capabilities)
