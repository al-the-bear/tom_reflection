...
library test_reflection.test.parameter_mirrors_test;

import 'package:test/test.dart';
import 'package:tom_reflection/tom_reflection.dart';
import 'parameter_mirrors_lib.dart' as lib;
import 'parameter_mirrors_test.reflection.dart';
...
void main() {
  ...
  test('Parameter mirrors', () {
    ...
    expect(
      f2Parameters[0].qualifiedName,
      'test_reflection.test.parameter_mirrors_test.A.f2.a',
    );
    ...
    expect(
      f3Parameters[1].qualifiedName,
      'test_reflection.test.parameter_mirrors_test.A.f3.b',
    );
    ...
    expect(
      f3Parameters[2].qualifiedName,
      'test_reflection.test.parameter_mirrors_test.A.f3.c',
    );
    ...
    expect(
      f4Parameters[1].qualifiedName,
      'test_reflection.test.parameter_mirrors_test.A.f4.b',
    );
    ...
    expect(
      f4Parameters[2].qualifiedName,
      'test_reflection.test.parameter_mirrors_test.A.f4.c',
    );
    ...
    expect(
      constructorParameters[0].qualifiedName,
      'test_reflection.test.parameter_mirrors_test.A..x',
    );
