...
@reflector
library test_reflection.test.library_declarations_test;

import 'package:tom_reflection/tom_reflection.dart';
import 'package:test/test.dart';
import 'library_declarations_test.reflection.dart';
...
void main() {
  ...
  var libraryMirror = reflector.findLibrary(
    'test_reflection.test.library_declarations_test',
  );
  var declarations = libraryMirror.declarations;

  // Commented out below: Cf. reflection issue #165.
