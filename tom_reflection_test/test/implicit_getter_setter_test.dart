...
library test_reflection.test.implicit_getter_setter_test;

import 'package:tom_reflection/tom_reflection.dart';
import 'package:test/test.dart';
import 'implicit_getter_setter_test.reflection.dart';
...
void main() {
  ...
  test('implicit getter properties', () {
    ...
    expect(
      ...
      'test_reflection.test.implicit_getter_setter_test.A.f1',
    );
    ...
    expect(
      ...
      'test_reflection.test.implicit_getter_setter_test.A.f2',
    );
    ...
    expect(
      ...
      'test_reflection.test.implicit_getter_setter_test.A.f3',
    );
    ...
    expect(
      ...
      'test_reflection.test.implicit_getter_setter_test.A.f4',
    );
    ...
    expect(
      ...
      'test_reflection.test.implicit_getter_setter_test.A.f5',
    );
