...
library test_reflection.test.multi_field_test;

import 'package:tom_reflection/tom_reflection.dart';
import 'package:test/test.dart';
import 'multi_field_test.reflection.dart';
...
void main() {
  ...
  test('multiple declarations with one type annotation, read', () {
    ...
    expect(() => bClassMirror.invokeGetter('notK'), throwsReflectionNoMethod);
    expect(() => bClassMirror.invokeGetter('notL'), throwsReflectionNoMethod);
  });
