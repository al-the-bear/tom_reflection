...
library test_reflection.test.serialize_test;

import 'package:test/test.dart';
import 'package:tom_reflection_test/tom_reflection_test.dart';
import 'serialize_test.reflection.dart';
...
void main() {
  ...
  test('Round trip test', () {
    ...
    // the expected map:
    expect(out, {
      'type': 'test_reflection.test.serialize_test.A',
      'fields': {
  ...
  test('Serialize subtype', () {
    ...
    expect(output, {
      ...
      'fields': {
        'a': {'type': 'num', 'val': 1},
        'b': {
          'type': 'test_reflection.test.serialize_test.B',
          'fields': {
            'a': {'type': 'num', 'val': 1},
            'b': {'type': 'num', 'val': 2},
            'c': {'type': 'num', 'val': 3},
