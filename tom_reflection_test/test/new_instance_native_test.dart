...
// reflection: Changed symbols to strings; added reflector and quantifier;
// removed usages of `reflectee` to bypass the mirror (that reflection
// already avoids creating). Uses type annotations like all other parts of
// reflection. This variant was again created as a variant of
...
import 'new_instance_native_test.reflection.dart';
