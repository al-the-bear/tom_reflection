...
library test_reflection.test.mixin_test;

import 'package:tom_reflection/tom_reflection.dart';
import 'package:test/test.dart';
import 'mixin_test.reflection.dart';
...
void main() {
  ...
  test('Mixin, superclasses included up to but not including bound', () {
    ...
    expect(cMirror.superclass!.superclass!.superclass, bMirror);
    expect(
      cMirror.superclass!.superclass!.superclass!.superclass != null,
      true,
    );
    expect(
  ...
  test('Mixin, naming', () {
    ...
    expect(
      ...
      'test_reflection.test.mixin_test.A with '
      'test_reflection.test.mixin_test.M1',
    );
    expect(
      bWithM2Mirror.simpleName,
      'test_reflection.test.mixin_test.B with '
      'test_reflection.test.mixin_test.M2',
    );
    expect(
      bWithM2WithM3Mirror.simpleName,
      'test_reflection.test.mixin_test.B with '
      'test_reflection.test.mixin_test.M2, '
      'test_reflection.test.mixin_test.M3',
    );
    expect(cMirror.simpleName, 'C');
    expect(dMirror.simpleName, 'D');

    expect(bMirror.qualifiedName, 'test_reflection.test.mixin_test.B');
    expect(cMirror.qualifiedName, 'test_reflection.test.mixin_test.C');
    expect(dMirror.qualifiedName, 'test_reflection.test.mixin_test.D');
    expect(
      aWithM1Mirror.qualifiedName,
      'test_reflection.test.mixin_test.'
      'test_reflection.test.mixin_test.A with '
      'test_reflection.test.mixin_test.M1',
    );
    expect(
