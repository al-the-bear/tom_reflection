...
library test_reflection.test.polymer_basic_needs_test;

import 'package:tom_reflection/tom_reflection.dart';
import 'package:test/test.dart';
import 'polymer_basic_needs_test.reflection.dart';
...
/// of his example building on both `reflection` and `smoke`, making the
...
List<DeclarationMirror> _query(Type dartType) {
  var mirror = myReflection.reflectType(dartType) as ClassMirror;
...
Object? read(Object instance, String name) {
  var mirror = myReflection.reflect(instance);
