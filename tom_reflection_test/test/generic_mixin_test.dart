...
library test_reflection.test.generic_mixin_test;

// See https://github.com/dart-lang/reflection/issues/59 for an explanation
// why we need to explicitly request coverage for `num`.
@GlobalQuantifyCapability(r'^dart.core.num$', reflector)
import 'package:tom_reflection/tom_reflection.dart';
import 'package:test/test.dart';
import 'generic_mixin_test.reflection.dart';
