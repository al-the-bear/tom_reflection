...
library test_reflection.test.subtype_test;

@GlobalQuantifyCapability(
  r'^test_reflection\.test\.subtype_test\..*',
  Reflector(),
)
@GlobalQuantifyCapability(
  r'^test_reflection\.test\.subtype_test\..*',
...
import 'subtype_test.reflection.dart';
...
class InsufficientReflector extends Reflection {
...
void main() {
  ...
  Reflection reflector = const Reflector();
  Reflection insufficientReflector = const InsufficientReflector();
