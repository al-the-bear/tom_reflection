...
library test_reflection.test.field_test;

import 'package:tom_reflection/tom_reflection.dart';
import 'package:test/test.dart';
import 'field_test.reflection.dart';

class FieldReflector extends Reflection {
...
class NoFieldReflector extends Reflection {
...
void main() {
  ...
  test('instance field properties', () {
    ...
    expect(f1Mirror.qualifiedName, 'test_reflection.test.field_test.A.f1');
    ...
    expect(f2Mirror.qualifiedName, 'test_reflection.test.field_test.A.f2');
  ...
  test('static field properties', () {
    ...
    expect(f3Mirror.qualifiedName, 'test_reflection.test.field_test.A.f3');
    ...
    expect(f4Mirror.qualifiedName, 'test_reflection.test.field_test.A.f4');
    ...
    expect(f5Mirror.qualifiedName, 'test_reflection.test.field_test.A.f5');
