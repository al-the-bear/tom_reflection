...
// library.
//
// So we add an import of 'reflection.dart' and of the generated code in
// 'exported_main_test.reflection.dart', and add `initializeReflection()`
...
// '*.reflection.dart' for each of those root libraries, but a library cannot
...
// program):
//
//   import 'sameNameAsThisFile.reflection.dart';
//   ...
//   main(String[] args) {
...
library test_reflection.test.exported_main_lib;

import 'package:test/test.dart';
import 'package:tom_reflection/tom_reflection.dart';
import 'exported_main_test.reflection.dart';
