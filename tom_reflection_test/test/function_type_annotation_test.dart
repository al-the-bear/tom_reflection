...
@reflector
library test_reflection.test.function_type_annotation_test;

import 'package:tom_reflection/tom_reflection.dart';
import 'package:test/test.dart';
import 'function_type_annotation_test.reflection.dart';
...
void main() {
  ...
  LibraryMirror libraryMirror = reflector.findLibrary(
    'test_reflection.test.function_type_annotation_test',
  );
