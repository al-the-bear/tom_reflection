...
Never unreachableError(String id, String message) {
  var extendedMessage =
      '*** [$id] Unexpected situation encountered!\n'
      'Please report a bug on github.com/dart-lang/reflection.\n'
      'Details: $message.';
...
/// The [id] parameter should be a unique identifier in the format
/// `[category.subcategory.error_type]` to help identify the error location.
Never unimplementedError(String id, String message) {
  var extendedMessage =
      '*** [$id] Unfortunately, this feature has not yet been '
      'implemented: $message.\n'
      'If you wish to ensure that it is prioritized, please report it '
      'on github.com/dart-lang/reflection.';
